...
namespace CityBuilderTests.Map
{
    [TestFixture]
    public class MapTests
    {
        ...
        {
            var map = new CityBuilder.Map.Map(Height, Width);
        ...
        private static bool NeighboursContainsAnyWithLocation(Point point, CityBuilder.Map.Map map, IEnumerable<ITile> neighbours)
        {
